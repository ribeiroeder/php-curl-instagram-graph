...
<p>If you prefer <strong>jQuery Ajax</strong>, this script follows the same concepts and classes <a href="https://github.com/ribeiroeder/jquery-feed-instagram-graph" target="blank">jQuery Ajax for feed Instagram Graph API</a></p>
